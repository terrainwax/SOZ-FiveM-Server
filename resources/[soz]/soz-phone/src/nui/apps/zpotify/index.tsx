...
import { Drawer, DrawerProps, Typography } from '@material-tailwind/react';
...
export const ZpotifyApp: React.FC = () => {
    ...
    const closeDrawerTop = () => {
        //drawerRef.current?.style.setProperty('opacity', '0');
        setOpenTop(false);
    };
    const openDrawerTop = () => {
        drawerRef.current?.style.setProperty('opacity', '1');
        setOpenTop(true);
    };
            ...
            >
                <AppWrapper className="h-[820px] w-full">
                    <AppWrapper className="h-[788px] w-full flex flex-col">
                        ...
                        {soundPlayer && playing && (
                            <div className="w-full bg-black/[0.6] h-[70px] flex flex-row" onClick={openDrawerTop}>
